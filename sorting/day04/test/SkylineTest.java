...
public class SkylineTest {
    ...
    @Test
    public void five() {
        List<Skyline.Point> a = Skyline.skyline(buildings(new int[][]{{0, 4, 4}, {1, 8, 2}, {1, 2, 2}, {2, 6, 1}, {4, 11, 3}, {7, 12, 2}, {10, 15, 3}, {11, 12, 5}, {13, 19, 5}, {15, 20, 2}, {16, 18, 5}, {19, 22, 1}, {19, 26, 2}, {20, 23, 1}, {21, 22, 1}, {21, 24, 4}, {21, 25, 4}, {21, 27, 1}, {25, 30, 4}, {25, 32, 4}, {27, 33, 2}, {30, 37, 4}, {32, 39, 1}, {36, 37, 3}, {40, 43, 3}}));
        assertSkylineEquals(
    ...
    @Test
    public void six() {
        List<Skyline.Point> a = Skyline.skyline(buildings(new int[][]{{1, 6, 1}, {2, 4, 2}, {3, 5, 3}, {6, 7, 2}}));
        assertSkylineEquals(
                Skyline.skyline(buildings(new int[][]{{1, 5, 1}, {2, 4, 2}, {3, 6, 3}, {6, 7, 2}})),
                new int[][]{{1, 1}, {2, 2}, {3, 3}, {6, 2}, {7, 0}}
        );
    }
}
